...
@RestController
@RequestMapping("/admin/rules/override")
public class OverridesController {
    ...
    public boolean updateOverride(@PathVariable String id, @RequestBody OverrideDTO overrideDTO) {
    ...
    public OverrideDTO detailOverride(@PathVariable String id) {
    ...
    public boolean enableOverride(@PathVariable String id) {
    ...
    public boolean disableOverride(@PathVariable String id) {
