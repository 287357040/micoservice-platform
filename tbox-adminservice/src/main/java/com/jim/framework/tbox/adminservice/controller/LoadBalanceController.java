...
import static com.jim.framework.tbox.adminservice.util.route.OverrideUtils.overrideToLoadBalance;

@RestController
@RequestMapping("/admin/rules/balancing")
public class LoadBalanceController {
    ...
    public boolean createLoadbalance(@RequestBody BalancingDTO balancingDTO) throws ParamValidationException {
    ...
    public boolean updateLoadbalance(@PathVariable String id, @RequestBody BalancingDTO balancingDTO) throws ParamValidationException {
    ...
    public BalancingDTO detailLoadBalance(@PathVariable String id) throws ParamValidationException {
        ...
        LoadBalance loadBalance = overrideToLoadBalance(override);
        BalancingDTO balancingDTO = new BalancingDTO();
